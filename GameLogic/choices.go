...
var NavChoices []Choice = []Choice{
	{Active: false, ChoiceText: "A corridor splits in half up ahead. Do you go left or right?", choices: []Option{}},
...
var BossChoice Choice = Choice{Active: false, ChoiceText: "You sense that a dastardly foe awaits ahead", choices: []Option{Option{id: 0, text: "No turning back now... (Press any key)"}}}
